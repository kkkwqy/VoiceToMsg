...
/**
 * Created by 18603 on 2018/6/13.
 */

public class VoiceToMsg extends CordovaPlugin {
    // 语音识别对象
...
//            stringBuffer.append("当前正在说话，音量大小：" + volume);
        ...
        public void onResult(final RecognizerResult result, boolean isLast) {
            ...
            if (isLast){
                callbackContext.success(stringBuffer.toString()+"123");
...
//            stringBuffer.append("结束说话");
            Toast.makeText(cordova.getActivity(),"已经结束",Toast.LENGTH_LONG).show();
        }
...
//            stringBuffer.append("开始说话");
            Toast.makeText(cordova.getActivity(),"请开始说话",Toast.LENGTH_LONG).show();
        }
...
//            Toast.makeText(cordova.getActivity(),"sssssssssssss",Toast.LENGTH_LONG).show();
            init();
